...
function openSpellingQuiz(options = {}) {
    ...
    overlay.innerHTML = `
        <div class="sp-container" style="position: relative;">
            ...
            <!-- Confirmation Modal -->
            <div id="sp-confirm-modal" class="fc-confirm-modal" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(11, 15, 25, 0.85); z-index: 1000; align-items: center; justify-content: center;">
